...
@implementation CJQMiddleView

static CJQMiddleView *_shareInstance;

+ (instancetype)shareInstance {
    if (_shareInstance == nil) {
        _shareInstance = [CJQMiddleView middleView];
    }
...
+ (instancetype)middleView {
    ...
    CJQMiddleView *middleView = [[[NSBundle mainBundle] loadNibNamed:@"CJQMiddleView" owner:nil options:nil] firstObject];
    return middleView;
}
